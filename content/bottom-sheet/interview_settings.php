<div class="content">
	...
	<table class="form-container">
		<tr>
			<td>
				<label>Interview examinees per date/time</label>
				<input type="number" name="max" value="<?php echo $oes->getSingleData("Administration", "MaxInterviewees", "SchoolYear = '".$oes->getSchoolYear()."'"); ?>">
			</td>
		</tr>
	</table><br>
...
$(document).ready(function() {
	$("#btnSave").click(function() {
		...
		$.ajax({
			type: "post",
			cache: true,
			url: "process.php?action=editinterviewsettings",
			data: {max: $max},
