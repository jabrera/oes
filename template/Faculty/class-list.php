<div id="body-container">
	<div class="content">
		...
		<div class="wrapper">
			...
			<div class="col-7" id="lstClassList">
			</div>
		</div>
		<script>
		function refreshGrades($section, $subject) {
			$("#lstClassList").html('<div class="card"><center><br><br><img src="images/skin/oslo/bg/loading.gif" /><br><br></center></div>');
			$.ajax({
				type: "post", 
				cache: true,
				url: "process.php?action=listclasslist",
				data: {section: $section, subject: $subject},
				success: function(html) {
					$("#loading").hide("slow");
					$("#lstClassList").html(html);
				}
			});
		}
		$(document).ready(function() {
